    ...
    <div className="container mx-auto p-6 py-25">
      <div className="mb-8 text-center">
        ...
        >
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle className="text-[#1f639e]">
            ...
            <form onSubmit={handleProfilePictureUpdate}>
              <div className="py-4 space-y-6">
                <div className="space-y-4">
                  <div>
                    <h3 className="font-medium text-[#1f639e]">
                      Current Picture
                    </h3>
                    ...
                    <div className="mt-2 flex justify-center">
                      <div className="relative h-24 w-24 rounded-full overflow-hidden border bg-gray-100">
                        <Image
                          src={
                            previewUrl ||
                            "https://placehold.co/150x150/cccccc/666666?text=Preview"
                          }
                ...
                <div>
                  <Label htmlFor="profilePicture" className="text-[#1f639e]">
      ...
      <div className="space-y-8">
        <div>
          <h2 className="text-xl font-semibold mb-4 text-[#1f639e]">
            Profile Information
          </h2>
          <div className="space-y-4">
            <div className="flex items-center justify-between rounded-lg border p-4 border-[#1f639e]">
              ...
              >
                ...
                <DialogContent>
                  ...
                  <div className="py-4">
                    <Label htmlFor="name" className="text-[#1f639e]">
                      Name
                    </Label>
                    <Input
                      id="name"
                ...
                <DialogContent className="sm:max-w-[425px]">
                  ...
                  <div className="py-4">
                    <div className="grid gap-4">
                      <div className="grid gap-2">
                        <Label htmlFor="email" className="text-[#1f639e]">
                          New Email Address
                        </Label>
                        <Input
                          id="email"
                  ...
                  <DialogFooter>
                    <p className="text-sm text-muted-foreground">
                      ...
                      address. Please click the link in the email to confirm the
                      change.
                    </p>
                  </DialogFooter>
                </DialogContent>
            ...
            >
              ...
              <DialogContent>
                ...
                <div className="py-4 space-y-4">
                  <div>
                    <Label htmlFor="old-password" className="text-[#1f639e]">
                      Old Password
                    </Label>
                    <Input
                      id="old-password"
                  ...
                  <div>
                    <Label htmlFor="new-password" className="text-[#1f639e]">
                      New Password
                    </Label>
                    <Input
                      id="new-password"
        ...
        <div>
          ...
          <div className="rounded-lg border border-destructive p-4">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  <AlertDialogTitle className="text-[#1f639e]">
                    Are you absolutely sure?
                  </AlertDialogTitle>
                  <AlertDialogDescription>
                    This action cannot be undone. This will permanently delete
                    your account and remove your data from our servers. To
                    confirm, please type your email address below.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <div className="py-4">
                  <Input
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel className="border-[#1f639e] text-[#1f639e] hover:text-[#164a73]">
                    Cancel
                  </AlertDialogCancel>
                  <AlertDialogAction
