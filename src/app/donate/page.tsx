...
export default function DonatePage() {
  ...
  return (
    <>
            ...
            <div className="grid lg:grid-cols-2 gap-0">
              ...
              <div className="p-6 sm:p-8 lg:p-12 flex flex-col justify-center bg-gray-50 lg:bg-white">
                <div data-aos="fade-right" data-aos-delay="200">
                  ...
                  <p className="text-gray-600 text-lg md:text-lg text-center lg:text-left leading-relaxed">
                    ...
                    future where knowledge knows no boundaries and learning opportunities are available to all.
                  </p>
                </div>
              </div>
              ...
              <div className="p-6 sm:p-8 lg:p-12 bg-white">
                <div data-aos="fade-left" data-aos-delay="400">
                  <h2 className="text-3xl font-bold text-[#1d588a] mb-4 text-center lg:text-left">Select An Amount</h2>
                  ...
                  <button
                    ...
                    disabled={isLoading || getDonationAmount() <= 0 || !firstName.trim() || !lastName.trim()}
                  ...
                  {/* PayPal Text */}
                  <Link href="#">
                    <p className="text-left text-[#164a73] text-sm mt-3 sm:mt-4" data-aos="fade-up" data-aos-delay="700">
                      Paypal
                    </p>
                  </Link>
                </div>
      ...
      <PaymentModal isOpen={isModalOpen} onClose={closeModal} sessionId={sessionId} />
    </>
  )
}
