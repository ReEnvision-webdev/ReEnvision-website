...
export default function DonationSuccess() {
  ...
  return (
    <div className="bg-[#F0F8FF] min-h-screen flex items-center justify-center px-4">
      <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center" data-aos="fade-up">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Your donation has been processed successfully. Thank you for supporting our mission to make education
