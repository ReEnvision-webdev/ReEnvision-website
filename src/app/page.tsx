...
import { Laptop, Link2, User, Users, ChevronDown, Book, Lock, Handshake } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-[#F0F8FF]">
      <section className="container mx-auto px-4 py-30">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            >
              Your Gateway To
              <br />
              <span className="text-[#00427A]" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300">
                UNLIMITED
              </span>
              <br />
              <span data-aos="fade-up" data-aos-duration="1200" data-aos-delay="500">
          ...
          >
            <div className="grid grid-cols-2 gap-6 max-w-lg">
              ...
              <div data-aos="flip-left" data-aos-duration="800" data-aos-delay="1200">
                <HexagonCard
                  index={1}
              ...
              <div data-aos="flip-left" data-aos-duration="800" data-aos-delay="1400">
                <HexagonCard
                  index={2}
              ...
              <div data-aos="flip-left" data-aos-duration="800" data-aos-delay="1600">
                <HexagonCard
                  index={3}
        ...
        <div className="flex justify-center mt-12" data-aos="bounce-in" data-aos-duration="1000" data-aos-delay="1800">
